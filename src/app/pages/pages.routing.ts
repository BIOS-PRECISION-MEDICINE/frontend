...
const routes: Routes = [
  {
    ...
    children: [
            ...
            {path:'exams-by-patient/:id_patient',canActivate:[ PermissionGuard,TokenGuard], component: ExamsByPatientComponent, data: { titulo: 'Exámenes por paciente', permiso: ORIGEN_PERMISSIONS.ACCESS_MODULE_ORIGEN }},

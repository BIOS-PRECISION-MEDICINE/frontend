...
export const environment = {
  ...
  url_main_backend:"http://127.0.0.1:3333",
  ...
  url_base_api:'http://127.0.0.1:3333',
  url_auth: 'http://127.0.0.1:3333/login-fake',
  //API permissions
  ...
  //API sub-tasks-EXAM
  url_api_subtask_exam: 'http://127.0.0.1:3333/subtasks-exam',
  //API parameters
